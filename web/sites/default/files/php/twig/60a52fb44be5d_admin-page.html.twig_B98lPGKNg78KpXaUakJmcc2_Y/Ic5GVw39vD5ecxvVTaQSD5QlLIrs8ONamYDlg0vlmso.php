...
class __TwigTemplate_cb9e3306f3d49c160db16420508614758f61ebc3f54b6710b84836ea9778561b extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<div class=\"clearfix\">
  ";
        // line 19
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\flag\TwigExtension\FlagCount']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["system_compact_link"] ?? null), 19, $this->source), "html", null, true));
        echo "
  ";
        // line 20
      ...
      ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["block"]) {
                // line 23
                echo "        ";
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\flag\TwigExtension\FlagCount']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($context["block"], 23, $this->source), "html", null, true));
                echo "
      ";
            }
...
", "core/modules/system/templates/admin-page.html.twig", "/var/www/web/core/modules/system/templates/admin-page.html.twig");
    }
